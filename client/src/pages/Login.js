    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900">College Q&A</h2>
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Use your college email to access the Q&A platform
              </p>
            </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-gray-500">
          <a href="/teacher-login" className="text-primary-600 hover:text-primary-800 underline">
            Teacher? Click here to access the teacher portal
          </a>
        </p>
